...
export async function generatePedagogicalResource(type: ResourceType, context: any | string): Promise<any> {
    ...
    prompt += `\n\nIMPORTANTE: Ao final da resposta, inclua uma recomendação de jogo do site Toy Theater (https://toytheater.com/) que se relacione com o tema. Formate esta recomendação COMO UM BLOCO JSON VÁLIDO no final do texto, delimitado por "---TOY_THEATER_DATA---" (antes e depois), seguindo este esquema:
    ---TOY_THEATER_DATA---
    {
        "category": "Math" | "Reading" | "Art" | "Music" | "Puzzles" | "Games",
        "name": "Nome do Jogo em Inglês (como no site)",
        "url": "URL do jogo (ex: https://toytheater.com/feed-the-monster/ ou https://toytheater.com/category/art/ se for de arte)",
        "description": "Breve explicação em português de como usar"
    }
    ---TOY_THEATER_DATA---`;
